...
Back up from https://raw.githubusercontent.com/EmpireProject/Empire/master/data/module_source/credentials/Invoke-Kerberoast.ps1 just taken to make sure if moved my own scripts wont break.
