...
<#
    ...
    Back up from https://raw.githubusercontent.com/PowerShellEmpire/PowerTools/master/PowerView/powerview.ps1 just taken to make sure if moved my own scripts won’t break. 
